...
const ProjectCard = ({ project, index, total }) => {
  ...
  return (
    <div ref={cardRef} className="project-card-wrapper" style={{ top: `${96 + index * 28}px` }}>
        ...
        <div className="project-grid">
          <div className="project-left">
            <div className="project-image-small">
              <img src={project.col1Image1} alt={`${project.name} preview 1`} loading="lazy" draggable={false} />
            </div>
            <div className="project-image-large">
              <img src={project.col1Image2} alt={`${project.name} preview 2`} loading="lazy" draggable={false} />
            </div>
          </div>
          <div className="project-image-tall">
            <img src={project.col2Image} alt={`${project.name} preview 3`} loading="lazy" draggable={false} />
          </div>
        </div>
      </motion.article>
    </div>
...
export default function ProjectsSection() {
  ...
  return (
    <section id="projects" className="projects-section" style={{ scrollMarginTop: "120px" }}>
      <FadeIn y={40}>
