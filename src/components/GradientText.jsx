...
export default function GradientText({
  ...
  return (
    <motion.div
      className={`relative mx-auto inline-flex max-w-fit flex-row items-center justify-center rounded-[1.25rem] font-medium ${blur ? "backdrop-blur" : ""} transition-shadow duration-500 overflow-hidden cursor-pointer ${showBorder ? "py-1 px-2" : ""} ${className}`}
